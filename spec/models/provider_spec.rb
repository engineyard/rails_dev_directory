...
describe Provider do
  ...
  describe "searching" do
    ...
    it "should search on services provided" do
      Provider.should_receive(:all).with(:joins => :provided_services, :group => 'provider_id', :conditions => ["aasm_state != 'flagged' and provided_services.technology_type_id IN (?)", [1,2,3]], :order => "aasm_state asc, if(recommendations_count >= 3,recommendations_count,0) desc, RAND()", :limit => 10)
